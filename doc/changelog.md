...
- Update generated settings:
  ...
  - enable yaml format on save through [Prettier extension](https://marketplace.visualstudio.com/items?itemName=prettier.prettier-vscode)
...
- Added [Prettier extension](https://marketplace.visualstudio.com/items?itemName=prettier.prettier-vscode) to {ref}`${vscodeExtensionsNames}<vscodeExtensionsNames>` config item (list of extensions suggestions)
